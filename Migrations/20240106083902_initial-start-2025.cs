...
{
    /// <inheritdoc />
    public partial class initialstart2025 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Adresses_Address",
                        column: x => x.Address,
                        principalTable: "Adresses",
                        principalColumn: "AdressID");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_ProfilePictures_Picture",
                        column: x => x.Picture,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalLetter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CVs_AspNetUsers_BelongsTo",
