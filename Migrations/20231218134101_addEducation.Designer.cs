...
namespace SkillSkulptor.Migrations
{
    ...
    [Migration("20231218134101_addEducation")]
            ...
            modelBuilder.Entity("SkillSkulptor.Models.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CvId = 1,
                            Degree = "Bachelor's",
                            EndDate = new DateTime(2022, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9154),
                            Institution = "University1",
                            StartDate = new DateTime(2019, 12, 18, 14, 40, 59, 445, DateTimeKind.Local).AddTicks(377)
                        },
                        new
                        {
                            EdID = 2,
                            ...
                            CvId = 1,
                            Degree = "Master's",
                            EndDate = new DateTime(2021, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9212),
                            Institution = "University2",
                            StartDate = new DateTime(2020, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9201)
                        },
                        new
                        {
                            EdID = 3,
                            ...
                            CvId = 2,
                            Degree = "Associate",
                            EndDate = new DateTime(2022, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9234),
                            Institution = "College1",
                            StartDate = new DateTime(2021, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9225)
                        });
                });
            ...
            modelBuilder.Entity("SkillSkulptor.Models.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Employer = "Company1",
                            EndDate = new DateTime(2022, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9598),
                            Position = "Developer",
                            StartDate = new DateTime(2020, 12, 18, 14, 40, 59, 446, DateTimeKind.Local).AddTicks(9566)
                        },
                        new
                        {
                            ExId = 2,
                            ...
                            Employer = "Company2",
                            EndDate = new DateTime(2022, 12, 18, 14, 40, 59, 447, DateTimeKind.Local).AddTicks(1628),
                            Position = "Intern",
                            StartDate = new DateTime(2021, 12, 18, 14, 40, 59, 447, DateTimeKind.Local).AddTicks(1592)
                        });
                });
