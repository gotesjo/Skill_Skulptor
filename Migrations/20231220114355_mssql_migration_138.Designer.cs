...
namespace SkillSkulptor.Migrations
{
    ...
    [Migration("20231220114355_mssql_migration_138")]
    partial class mssql_migration_138
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SkillSkulptor.Models.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CvId = 1,
                            Degree = "Bachelor's",
                            EndDate = new DateTime(2022, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3019),
                            Institution = "University1",
                            StartDate = new DateTime(2019, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(2505)
                        },
                        new
                        {
                            EdID = 2,
                            ...
                            CvId = 1,
                            Degree = "Master's",
                            EndDate = new DateTime(2021, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3076),
                            Institution = "University2",
                            StartDate = new DateTime(2020, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3031)
                        },
                        new
                        {
                            EdID = 3,
                            ...
                            CvId = 2,
                            Degree = "Associate",
                            EndDate = new DateTime(2022, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3120),
                            Institution = "College1",
                            StartDate = new DateTime(2021, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3096)
                        });
                });
            ...
            modelBuilder.Entity("SkillSkulptor.Models.Experience", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Employer = "Company1",
                            EndDate = new DateTime(2022, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3226),
                            Position = "Developer",
                            StartDate = new DateTime(2020, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3222)
                        },
                        new
                        {
                            ExId = 2,
                            ...
                            Employer = "Company2",
                            EndDate = new DateTime(2022, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3235),
                            Position = "Intern",
                            StartDate = new DateTime(2021, 12, 20, 12, 43, 53, 434, DateTimeKind.Local).AddTicks(3232)
                        });
                });
