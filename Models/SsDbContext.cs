...
{
    public class SsDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    new AppUser {Id = "2", Firstname = "John", Lastname = "Doe", Email = "john.doe@example.com", PasswordHash = "password1", Phonenr = "123456789", ProfileAccess = true, Active = true, Address = 1, Picture = 1 },
            //    new AppUser {Id = "1", Firstname = "Jane", Lastname = "Smith", Email = "jane.smith@example.com", PasswordHash = "password2", Phonenr = "987654321", ProfileAccess = true, Active = true, Address = 2, Picture = 2 }
            //);
